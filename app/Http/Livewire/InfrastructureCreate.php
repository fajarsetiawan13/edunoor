...
class InfrastructureCreate extends Component
{
    ...
    public $A1, $A2, $A3, $A4, $A5, $B1, $B2, $B3;
    ...
    public $explanation_B1, $explanation_B2, $explanation_B3;
    public $explanation_C1, $explanation_C2, $explanation_C3;
    public $explanation_C4, $explanation_C5, $explanation_C6;
    public $explanation_C7, $explanation_C8, $explanation_C9;
