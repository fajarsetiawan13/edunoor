                        ...
                        <div class="card-body">
                            ...
                            <div class="form-control w-full mb-3">
                                ...
                                <label class="label justify-start cursor-pointer">
                                    <input type="radio" name="C2" value="Baik" class="radio" {{ ($infrastructure[0]->C2 == 'Baik') ? 'checked' : '' }}/>
                                    <span class="label-text ml-3">Baik</span> 
                                </label>
                                <label class="label justify-start cursor-pointer">
                                    <input type="radio" name="C2" value="Tidak Baik" class="radio" {{ ($infrastructure[0]->C2 == 'Tidak Baik') ? 'checked' : '' }}/>
