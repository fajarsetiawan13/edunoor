<div class="btm-nav border-t-[1px] md:invisible shadow-lg">
    <a href="{{ Request::is('dashboard') ? '#' : '/dashboard'}}"
        class="{{ Request::is('dashboard*') ? 'active bg-slate-100' : 'hover:bg-slate-100'}}">
    ...
    <a href="{{ Request::is('qr') ? '#' : '/qr'}}"
        class="{{ Request::is('qr*') ? 'active bg-slate-100' : 'hover:bg-slate-100'}}">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
            style="fill: rgba(50, 50, 50, 1);transform: ;msFilter:;">
            @if(Request::is('qr*'))
    ...
    <a href="{{ Request::is('setting') ? '#' : '/setting'}}"
        class="{{ Request::is('setting*') ? 'active bg-slate-100' : 'hover:bg-slate-100'}}">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
            style="fill: rgba(50, 50, 50, 1);transform: ;msFilter:;">
