<ul class="menu bg-base-100 w-full rounded-box">
    ...
    <li>
        <a class="{{ Request::is('dashboard/schools*') ? 'active' : ''}}"
            href="{{ Request::is('dashboard/schools') ? '#' : '/dashboard/schools'}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="M21 10h-2V4h1V2H4v2h1v6H3a1 1 0 0 0-1 1v9h20v-9a1 1 0 0 0-1-1zm-7 8v-4h-4v4H7V4h10v14h-3z"></path><path d="M9 6h2v2H9zm4 0h2v2h-2zm-4 4h2v2H9zm4 0h2v2h-2z"></path></svg>
            Daftar Sekolah
        </a>
    </li>
    <li>
        <a class="{{ Request::is('dashboard/questionare*') ? 'active' : ''}}"
            href="{{ Request::is('dashboard/questionare') ? '#' : '/dashboard/questionare'}}">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;">
                @if(Request::is('dashboard/questionare*'))
    ...
    <li>
        <a class="{{ Request::is('setting*') ? 'active' : ''}}"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" style="fill: rgba(50, 50, 50, 1);transform: ;msFilter:;">
