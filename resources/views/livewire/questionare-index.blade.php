<div>
    ...
    <label class="btn btn-sm btn-primary w-full md:w-1/3 md:btn-md text-white mb-3" for="questionare-create">Tambah
        Pertanyaan Baru</label>
    ...
    <table class="table w-full table-fixed mb-3">
        <thead>
            <tr>
                ...
                <th scope="col" class="w-9/12 truncate text-left">Pertanyaan</th>
        ...
        <tbody>
            ...
            <tr class="hover">
                ...
                <td class="whitespace-pre-line">{!! $q->question !!}</td>
                <td>
                    <div class="dropdown dropdown-left">
                        ...
                        <ul tabindex="0" class="dropdown-content menu p-2 shadow bg-base-100 rounded-box w-52">
                            <li>
                                <label wire:click='getQuestion({{ $q->id }})' class="modal-btn"
                                    for="questionare-update">Edit
                                    Pertanyaan</label>
                            </li>
                            <li>
                                <a onclick="return confirm('Anda ingin menghapus pertanyaan?') || event.stopImmediatePropagation()" wire:click='destroy({{ $q->id }})'>Hapus Pertanyaan</a>
                            </li>
                        </ul>
                    </div>
                </td>
